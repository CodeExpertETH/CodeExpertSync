...
>(
  ...
  | (ClassAttributes<T> & P & ExtractVariantProps<C>)
  | (null & React.RefAttributes<ReactSVGElement>)
>;
export function styled<
...
>(
  ...
  | (ClassAttributes<T> & P & ExtractVariantProps<C>)
  | (null & React.RefAttributes<DOMElement<P, T>>)
>;
...
export function styled<P extends {}, C extends CSSWithVariants>(
  ...
  | (ClassAttributes<ClassicComponent<P, ComponentState>> &
      ...
      ExtractVariantProps<C>)
  | (null &
      React.RefAttributes<CElement<P, ClassicComponent<P, ComponentState>>>)
>;
export function styled<
  // eslint-disable-next-line @typescript-eslint/ban-types
  P extends {},
...
>(
  ...
  | (ClassAttributes<T> & P & ExtractVariantProps<C>)
  | (null & React.RefAttributes<CElement<P, T>>)
>;
// eslint-disable-next-line @typescript-eslint/ban-types
export function styled<P extends {}, C extends CSSWithVariants>(
  ...
  | (Attributes & P & ExtractVariantProps<C>)
  | (null & React.RefAttributes<ReactElement<P>>)
>;
...
export function styled(
  ...
  $Unexpressable &
    ExtractVariantProps<$Unexpressable> &
  ...
  const Component = React.forwardRef(
    ({ className, ...overloadedProps }: $Unexpressable, ref) => {
      ...
      return React.createElement(Element, {
        ...props,
        className: [className, scopedClassNames, ...variantClassList]
          .filter(Boolean)
          .join(" "),
        ref,
      });
