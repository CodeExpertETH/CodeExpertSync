...
/**
 * This intentionally only accepts {@link taskOption.TaskOption TaskOption<void>}, to make it harder to just discard
 * the case where the {@link option.Option Option} is {@link option.None None}.
 *
 * If you need to move into imperative territory and want to process the Option further, use {@link task.toPromise}.
 */
